/**本插件与2016.7.10胡dl开发仅限技术交流请勿进行商业用途！！谢谢配合，QQ交流569662340**/
;(function($){
	$.fn.orso=function(opints){
		...
		$(outside.boxlan).off("click").on("click",function(){
			left();
		});
		$(outside.boxran).off("click").on("click",function(){
			right();
		});
		$(outside.boxtan).off("click").on("click",function(){
			top();
		});
		$(outside.boxban).off("click").on("click",function(){
			bottom();
		});
		function allleft(){
		...
		$(outside.boxalllan).off("click").on("click",function(){
			allleft();
		});
		$(outside.boxallran).off("click").on("click",function(){
			allright();
		});
		$(outside.boxalltan).off("click").on("click",function(){
			alltop();
		});
		$(outside.boxallban).off("click").on("click",function(){
			allbottom();
		});
	};
})(jQuery);
